...
q<-c(18,90,180)
par(mfrow = c(2,1), mar = c(2,2.2,1.5,2), oma = c(1,1,1,1))
...
legend("topright",legend=leg,col=yan,pch=pcc,lwd=1.5,lty=2,cex=0.8,inset=.06,bty="n")
...
legend("topright",legend=leg,col=yan,pch=pcc,lwd=1.5,lty=2,inset=.06,cex=0.8,bty="n")
