...
mtext("2.2kv-fe",3,line=0,font=2,cex=1.1)
...
leg<-c("liquid1-18nl/min","liquid1-180nl/min","liquid2-18nl/min","liquid2-90nl/min",
"liquid2-180nl/min")
...
q1<-read.xlsx("liquid1.xlsx",sheetName="2kv-18",header=TRUE)
q2<-read.xlsx("liquid1.xlsx",sheetName="2kv-180",header=TRUE)
q3<-read.xlsx("liquid2.xlsx",sheetName="2kv-18",header=TRUE)
q4<-read.xlsx("liquid2.xlsx",sheetName="2kv-90",header=TRUE)
q5<-read.xlsx("liquid2.xlsx",sheetName="2kv-180",header=TRUE)
...
text(400,30,"2kv-fe",col="black",font=2)
