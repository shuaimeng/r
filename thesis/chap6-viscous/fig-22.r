...
mtext("Liquid2-ratio",3,line=0,font=2)
...
lines(k7$fv,k7$raeva,col=yan[7],lwd=1.5,lty=2,type="b",pch=pcc[7],cex=0.8)
lines(k8$fv,k8$raeva,col=yan[8],lwd=1.5,lty=2,type="b",pch=pcc[8],cex=0.8)
