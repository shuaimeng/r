...
main = "", xlim = c(0,800),ylim=c(10,90))

mtext("Liquid2-d",3,line=0,font=2)
...
lines(k7$fv,k7$deva,col=yan[7],lwd=1.5,lty=2,type="b",pch=pcc[7],cex=0.8)
lines(k8$fv,k8$deva,col=yan[8],lwd=1.5,lty=2,type="b",pch=pcc[8],cex=0.8)
...
error.bar(k7$fv,k7$deva,k7$stdd/2,col=yan[7])
error.bar(k8$fv,k8$deva,k8$stdd/2,col=yan[8])
