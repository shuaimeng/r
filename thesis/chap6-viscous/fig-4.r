...
main = "Liquid1", xlim = c(0,800),ylim=c(0,1000))
...
error.bar(k4$fv,k4$fveva,k1$stdfv/2,col=yan[4])
error.bar(k5$fv,k5$fveva,k2$stdfv/2,col=yan[5])
error.bar(k6$fv,k6$fveva,k3$stdfv/2,col=yan[6])
...
ylab = expression(italic(f["p"])(Hz)), mgp=c(1.1, 0, 0),tck=0.02,
main = "Liquid2", xlim = c(0,800),ylim=c(0,1000))
...
legend("topleft",legend=leg,col=yan,pch=pcc,lwd=1.5,lty=2,inset = .02,bty = "n",cex=0.7)
