...
main = "18nl/min-ratio", xlim = c(0,800),ylim=c(0,20))
...
legend("bottomright",legend=leg,col=yan,pch=pcc,lwd=1.5,lty=2,inset = .02,bty = "n",cex=0.8)
...
ylab = expression(italic(d["d"])(um)), mgp=c(1.1, 0, 0),tck=0.02,
main = "180nl/min-ratio", xlim = c(0,800),ylim=c(0,20))
