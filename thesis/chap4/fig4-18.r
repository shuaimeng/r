...
plot(q2$fv, q2$X2, xaxs = "i", col = 0, xlab = expression(italic(f["v"]) (Hz)),
     ylab = expression(italic(ratio)), mgp=c(1, 0, 0),tck=0.01,main = "", cex.lab = 1, cex.main = 1, xlim = c(0, 3500), ylim = c(0, 20))

points(q2$fv,(160/q2$X2),col="red",pch=0,cex=0.5)
points(q2$fv,(160/q2$X3),col="blue",pch=1,cex=0.5)

points(q5$fv,(160/q5$X4),col="green3",pch=2,cex=0.5)
points(q5$fv,(160/q5$X5),col="black",pch=5,cex=0.5)

lines(loess.smooth(q2$fv,(160/q2$X2), span=0.8,degree=2), col="red", lwd=2,lty=2)
lines(loess.smooth(q2$fv,(160/q2$X3), span=0.8,degree=2), col="blue", lwd=2,lty=2)
...
lines(loess.smooth(q5$fv,(160/q5$X4), span=0.8,degree=2), col="green3", lwd=2,lty=2)
lines(loess.smooth(q5$fv,(160/q5$X5), span=0.8,degree=2), col="black", lwd=2,lty=2)
