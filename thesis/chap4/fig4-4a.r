...
par(mfrow=c(2,2), mgp = c(1.5, 0.5, 0),tck=0.02,mar=c(2.4,2.6,1,1), oma=c(2,2,2,2))


#######占空比0.2####
plot(k1[,1],  (v+(duty[1]*q[1]))/(k1[,1]*k1[,2]^2),lwd=1.5,cex=0.6,lty=2, log="x",xlab=expression(log(italic(f["v"])) (Hz)), ylab=expression(italic(F)(N)), main="", col=0, pch=pchc[1], ylim=c(0,8e-14))

mtext("k=0.2",3,line=0,font=2,cex=0.8)
...
#####占空比0.3####
plot(k2[,1],  (v+(duty[2]*q[1]))/(k2[,1]*k2[,2]^2), log="x",lwd=1.5,cex=0.6,lty=2,xlab=expression(log(italic(f["v"])) (Hz)), ylab=expression(italic(F)(N)), main="", col=0, pch=pchc[1], ylim=c(0,3e-14))

mtext("k=0.3",3,line=0,font=2,cex=0.8)
...
###占空比0.4###
plot(k3[,1],  (v+(duty[3]*q[1]))/(k3[,1]*k3[,2]^2), log="x", lwd=1.5,cex=0.6,lty=2,xlab=expression(log(italic(f["v"])) (Hz)), ylab=expression(italic(F)(N)), main="", col=0, pch=pchc[1], ylim=c(0,3e-14))

mtext("k=0.4",3,line=0,font=2,cex=0.8)
...
####占空比0.5####
plot(k4[,1],  (v+(duty[4]*q[1]))/(k4[,1]*k4[,2]^2),log="x",wd=1.5,cex=0.6,lty=2, xlab=expression(log(italic(f["v"])) (Hz)), ylab=expression(italic(F)(N)), main="", col=0, pch=pchc[1], ylim=c(0,3e-14))

mtext("k=0.5",3,line=0,font=2,cex=0.8)
