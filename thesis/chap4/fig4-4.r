...
par(fig=c(0,1,0,1), mar = c(2.5,2.5,1,0.8), oma = c(1,1,1,1),new=FALSE)

plot(Rnn, 1000*(q[1]/(pi*Rn^2)),mgp = c(1.5, 0.5, 0),tck=0.02,
     type="b", xlab=expression(italic(r["n"](mm))), ylab=expression(italic(U["o"](mm/s))), main="", lwd=2, lty=1, col="red",pch=21,cex=0.6,cex.axis=1,cex.lab=1, ylim=c(0,5e-2))
...
#######
par(fig=c(0.35,0.98,0.3,0.98), new=TRUE)

Rn2<-c(0.12e-3,0.105e-3,0.09e-3,0.08e-3) #针头内径
Rn22<-1000*Rn2

plot(Rn22, 1000*(q[1]/(pi*Rn2^2)), bty="n",cex=0.6,mgp = c(1.5, 0.5, 0),tck=0.02,type="b", xlab="30G\\28G\\27G\\26G(mm)", ylab=expression(italic(U["o"](mm/s))), main="", lwd=2, lty=1, col="red",cex.axis=0.9,cex.lab=0.9, pch=21, ylim=c(0,20e-2))
...
legend("topright",c("1.5nl/min","27nl/min","54nl/min","180nl/min"), inset=0.06, cex=0.9,col=mycolors, pch=pchc,lwd=2, lty=3,bty="n")
