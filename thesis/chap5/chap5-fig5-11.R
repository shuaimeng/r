...
mtext("18nlmin",col="black",3,line=-1.2,font=2,cex=0.8)
#30g,32g,34g##
...
legend("topright",c("25G","30G","32G","34G"),col=c("green3","red","blue","black"),pch=c(1,2,15,16),lwd=1.5,lty=2,bty="n",inset=.02,cex=0.8)
...
plot(n2$fv, n2$d_ra, xlab = expression(italic(f["v"](Hz))),
     ...
     mtext("54nlmin",col="black",3,line=-1.2,font=2,cex=0.8)
#30g,32g,34g##
...
plot(n3$fv, n3$d_ra, xlab = expression(italic(f["v"](Hz))),
     ...
     mtext("180nlmin",col="black",3,line=-1.2,font=2,cex=0.8)
#30g,32g,34g##
