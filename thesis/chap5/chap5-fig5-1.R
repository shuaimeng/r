...
####25G####
par(fig=c(0,0.5,0.5,1),mar = c(1.8,2.2,1.8,1.8), oma = c(1,1,1,1),new=F)
plot(nj$fv, nj$feeva, xlab = expression(f["v"](Hz)),
     ylab=expression(italic(f["e"])(Hz)),mgp=c(1.1, 0, 0),tck=0.01,main = "25G", cex.lab = 1, cex.main = 1,xlim=c(0,200),ylim=c(0,100),col=0)
#18
lines(nk$fv,nk$feeva,col="red",pch=2,lwd=1.5,lty=2,type="b",cex=0.8)

#54
lines(nj$fv,nj$feeva,col="blue",pch=1,lwd=1.5,lty=2,type="b",cex=0.8)

#180
lines(nl$fv,nl$feeva,col="black",pch=15,lwd=1.5,lty=15,type="b",cex=0.8)
#34g
...
legend("topright",c("18nl/min",
                    "54nl/min","180nl/min"),
       pch=c(1,2,15),bty="n",lty=2,col=c("red","blue","black"),inset=.02,cex=0.8)

###30G####
par(fig=c(0.5,1,0.5,1), new=T)
plot(na$fv, na$d_ra, xlab = expression(italic(f["v"])(Hz)),
     ylab=expression(italic(f["e"])(Hz)),mgp=c(1.1, 0, 0),tck=0.02,main = "30G", cex.lab = 1, cex.main = 1,xlim=c(0,200),ylim=c(0,250),col=0)

#25g
lines(na$fv,na$feeva,col="red",pch=1,lwd=1.5,lty=2,type="b",cex=0.8)
#30g
lines(nc$fv,nc$feeva,col="blue",pch=15,lwd=1.5,lty=2,type="b",cex=0.8)
#32g
lines(nb$fv,nb$feeva,col="black",pch=2,lwd=1.5,lty=2,type="b",cex=0.8)
...
plot(na$fv, na$d_ra, xlab = expression(italic(f["v"])(Hz)),ylab="",mgp=c(1, 0, 0),tck=0.005,cex.axis=0.8,cex.lab=0.8,xlim=c(0,3000),ylim=c(0,250),col=0)
lines(na$fv,na$feeva,col="red",pch=1,lwd=1.5,lty=2,type="b",cex=0.8)
lines(nc$fv,nc$feeva,col="blue",pch=15,lwd=1.5,lty=2,type="b",cex=0.8)
lines(nb$fv,nb$feeva,col="black",pch=2,lwd=1.5,lty=2,type="b",cex=0.8)
...
legend("topright",c("18nl/min",
                    "54nl/min","180nl/min"),
       pch=c(1,2,15),bty="n",lty=2,col=c("red","blue","black"),cex=0.8,inset=.02)


####32G####
par(fig=c(0,0.5,0,0.5), new=T)
plot(nd$fv, nd$d_ra, xlab = expression(italic(f["v"])(Hz)),
     ylab=expression(italic(f["e"])(Hz)),mgp=c(1.1, 0, 0),tck=0.02,main = "32G", cex.lab = 1, cex.main = 1,xlim=c(0,200),ylim=c(0,250),col=0)
#25g
lines(nd$fv,nd$feeva,col="red",pch=1,lwd=1.5,lty=2,type="b",cex=0.8)
#30g
lines(nf$fv,nf$feeva,col="blue",pch=2,lwd=1.5,lty=2,type="b",cex=0.8)
#32g
...
plot(nd$fv, nd$d_ra, xlab = expression(italic(f["v"])(Hz)),ylab="",cex.axis=0.8,cex.lab=0.8,mgp=c(1, 0, 0),tck=0.005,xlim=c(0,3500),ylim=c(0,250),col=0)
lines(nd$fv,nd$feeva,col="red",pch=1,lwd=1.5,lty=2,type="b",cex=0.8)
lines(nf$fv,nf$feeva,col="blue",pch=2,lwd=1.5,lty=2,type="b",cex=0.8)
lines(ne$fv,ne$feeva,col="black",pch=15,lwd=1.5,lty=2,type="b",cex=0.8)
...
plot(ng$fv, ng$d_ra, xlab = expression(italic(f["v"])(Hz)),
     ylab=expression(italic(f["e"])(Hz)),mgp=c(1.1, 0, 0),tck=0.02,main = "34G", cex.lab = 1, cex.main = 1,xlim=c(0,200),ylim=c(0,250),col=0)
#25g
lines(ng$fv,ng$feeva,col="red",pch=1,lwd=1.5,lty=2,type="b",cex=0.8)
#30g
lines(nh$fv,nh$feeva,col="blue",pch=2,lwd=1.5,lty=2,type="b",cex=0.8)
#32g
lines(ni$fv,ni$feeva,col="black",pch=15,lwd=1.5,lty=2,type="b",cex=0.8)
#34g
#lines(ni$fv,ni$feeva,col="green3",pch=16,lwd=1.5,lty=2,type="b",cex=0.7)
...
plot(ng$fv, ng$d_ra, xlab = expression(italic(f["v"])(Hz)),ylab="",mgp=c(1, 0, 0),tck=0.005,cex.axis=0.8,cex.lab=0.8,xlim=c(0,3500),ylim=c(0,250),col=0)
lines(ng$fv,ng$feeva,col="red",pch=1,lwd=1.5,lty=2,type="b",cex=0.8)
lines(nh$fv,nh$feeva,col="blue",pch=2,lwd=1.5,lty=2,type="b",cex=0.8)
lines(ni$fv,ni$feeva,col="black",pch=15,lwd=1.5,lty=2,type="b",cex=0.8)
