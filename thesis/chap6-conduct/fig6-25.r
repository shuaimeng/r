...
k2<-read.xlsx("gly2.xlsx",sheetName="qd1-20",header=TRUE)
k3<-read.xlsx("gly3.xlsx",sheetName="qd1-20",header=TRUE)

k4<-read.xlsx("gly1.xlsx",sheetName="qd2-20",header=TRUE)
k5<-read.xlsx("gly2.xlsx",sheetName="qd2-20",header=TRUE)
