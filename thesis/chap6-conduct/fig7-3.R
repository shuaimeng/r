...
plot(k1$fv,k1$tfeva, col=0,xlab = expression(italic(f["v"]) (Hz)), 
     ...
     main = "tfor-1.8kv", xlim = c(0,500),ylim=c(0,40))
...
legend("topright",legend=leg,lwd=1.5,lty=2,pch=pcc,col=yan,inset = .05,bty="n",cex=0.8)
...
plot(k1$fv,k1$tfeva,bty="n",col=0,xlab ="", 
     ...
     main = "", xlim = c(500,3000),ylim=c(0,2),cex.axis=0.8)
...
plot(k1$fv,k1$tpeva, col=0,xlab = expression(italic(f["v"]) (Hz)), 
     ...
     main = "tp-1.8kv", xlim = c(0,500),ylim=c(0,0.8))
...
plot(k1$fv,k1$tpeva, bty="n",col=0,xlab = "", 
     ylab = "", mgp=c(1.1, 0, 0),tck=0.02, 
     main = "", xlim = c(500,3000),ylim=c(0,0.5),cex.axis=0.8)
