...
text(3300,2200,"fpmax=100Hz",col=yan[1],font=2)
text(3300,2000,"fpmax=2KHz",col=yan[2],font=2)
text(3300,1800,"fpmax=4KHz",col=yan[3],font=2)
text(3300,1600,"fpmax=3KHz",col=yan[4],font=2)
text(3300,1400,"fpmax=1.5KHz",col=yan[5],font=2)
text(3300,1200,"fpmax=1.5KHz",col=yan[6],font=2)

leg<-c("gly1-1.8kv","gly1-1.9kv","gly1-2kv","gly2-1.8kv","gly2-1.9kv","gly2-2kv")

legend("topleft",legend=leg,col=yan,pch=pcc,lty=2,lwd=2,inset=.01,bty="n",cex=0.9)
