...
#保存pdf
pdf("iso_flowrate.pdf")

################################画图-高度曲线###########################
plot(men_qh$voltage, men_qh$X6e.04, col=0, xaxs="i", xlim=c(1.5, 2.6), ylim=c(0.1, 0.8), 
xlab="Flowrate (nl/min)", cex.lab=1, ylab="Height of Meniscus (mm)", main="Height with Q  of Iso-propyl")
...
##############################画图--角度曲线############################
plot(men_qa$voltage, men_qa$X6e.04, col=0, xaxs="i", xlim=c(1.5, 2.6), ylim=c(50, 135), 
xlab="Flow rate (nl/min)", cex.lab=1, ylab="Taylor Angle (°)", main="Angle with Q  of Iso-propyl")
