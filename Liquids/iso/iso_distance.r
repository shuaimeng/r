...
#保存pdf
pdf("iso_distance.pdf")

#########################研究ethanol与distance的关系#################

################################画图-高度曲线###########################
plot(men_dh$voltage, men_dh$X1, col=0, xaxs="i", xlim=c(1.1, 2.9), ylim=c(0.1, 1.0), 
...
##############################画图--角度曲线############################
plot(men_da$voltage, men_da$X1, col=0, xaxs="i", xlim=c(1.1, 2.9), ylim=c(50, 135), 
