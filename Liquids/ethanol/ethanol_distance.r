...
#保存pdf
pdf("ethanol_distance.pdf")

#########################研究ethanol与distance的关系#################

################################画图-高度曲线###########################
plot(men_dh$voltage, men_dh$X1, col=0, xaxs="i", xlim=c(1.4, 2.5), ylim=c(0.1, 1.3), 
...
##############################画图--角度曲线############################
plot(men_da$voltage, men_da$X1, col=0, xaxs="i", xlim=c(1.4, 2.5), ylim=c(50, 145), 
