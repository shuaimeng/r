...
lines(lowess(q4$fv, q4$X1.5,f=0.1,iter=3), col="green4", lwd=2, type="l", lty=2)
lines(lowess(q4$fv, q4$X27,f=0.1,iter=3),col="black", lwd=2, type="l", lty=2)
lines(lowess(q4$fv, q4$X54,f=0.1,iter=3),col="red", lwd=2, type="l", lty=2)
lines(lowess(q4$fv, q4$X180,f=0.1,iter=3),col="blue", lwd=2, type="l", lty=2)
...
lines(lowess(q5$fv, q5$X1.5,f=0.1,iter=3), col="green4", lwd=2, type="l", lty=2)
lines(lowess(q5$fv, q5$X27,f=0.1,iter=3), col="black", lwd=2, type="l", lty=2)
lines(lowess(q5$fv, q5$X54,f=0.1,iter=3),col="red", lwd=2, type="l", lty=2)
lines(lowess(q5$fv, q5$X180,f=0.1,iter=3),col="blue", lwd=2, type="l", lty=2)
