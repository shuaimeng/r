...
##################################画图--占空比k为0.3#######################
plot(q2$fv, q2$X0.2, xaxs = "i", col = 0, xlab = "Voltage frequency (Hz)", ylab = "Formation time t_for (ms)", main = "Formation time in Q 1.5nl/min", cex.lab = 1.2, cex.main = 1.5, xlim = c(0, 1050), ylim = c(0.2, 40))
...
plot(q2$fv, q2$X0.2, xaxs = "i", col = 0, xlab = "0 ~ 250 Hz", ylab = "t_for (ms)", main = "", cex.lab = 1.2, cex.main = 1.5, xlim = c(0, 250), ylim = c(0.2, 40))
...
plot(q2$fv, q2$X0.2, xaxs = "i", col = 0, xlab = "0 ~ 125 Hz", ylab = "t_for (ms)", main = "", cex.lab = 1.2, cex.main = 1.5, xlim = c(0, 125), ylim = c(0.2, 38))
