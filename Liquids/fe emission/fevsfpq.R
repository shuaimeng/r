...
plot(q2$fv, q2$X0.2, xaxs = "i", col = 0, xlab = expression(italic(f["v"]) (Hz)), 
     ylab = expression(italic(f["e"]) (Hz)), mgp=c(1.3, 0, 0),tck=0.03, main = "1.5nl/min", cex.lab = 1.2, cex.main = 1.5, xlim = c(0, 50), ylim = c(0, 200))
...
plot(q3$fv, q3$X0.2, xaxs = "i", col = 0, xlab = expression(italic(f["v"]) (Hz)), 
     ylab = expression(italic(f["e"]) (Hz)), mgp=c(1.3, 0, 0),tck=0.03,main = "27nl/min", cex.lab = 1.2, cex.main = 1.5, xlim = c(0, 50), ylim = c(0, 200))
...
plot(q4$fv, q4$X0.2, xaxs = "i", col = 0, xlab = expression(italic(f["v"]) (Hz)), 
     ylab = expression(italic(f["e"]) (Hz)),mgp=c(1.3, 0, 0),tck=0.03, main = "54nl/min", cex.lab = 1.2, cex.main = 1.5, xlim = c(0, 50), ylim = c(0, 200))
...
plot(q5$fv, q5$X0.2, xaxs = "i", col = 0, xlab = expression(italic(f["v"]) (Hz)), 
     ylab = expression(italic(f["e"]) (Hz)), mgp=c(1.3, 0, 0),tck=0.03,main = "180nl/min", cex.lab = 1.2, cex.main = 1.5, xlim = c(0, 50), ylim = c(0, 200))
