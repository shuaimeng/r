...
##################################画图--占空比k为0.2#######################
plot(k2$fv, k2$X1.5, xaxs = "i", col = 0, xlab = "Voltage frequency (Hz)", ylab = "Frequency in cycle (Hz)", main = "Eject frequency in duty = 0.2", cex.lab = 1.2, cex.main = 1.5, xlim = c(0, 1050), ylim = c(0, 110))
...
plot(k2$fv, k2$X1.5, xaxs = "i", col = 0, xlab = "0 ~ 250 Hz", ylab = "f_eject in cycle (Hz)", main = "", cex.lab = 1.2, cex.main = 1.5, xlim = c(0, 250), ylim = c(0, 110))

#model1 = loess(k2$X1.5 ~ k2$fv, span = 0.8 , degree = 2)
lines(k2$fv, k2$X1.5,  col="#458B74", lwd=2.5, type="l", lty=3)

#model2 = loess(k2$X27 ~ k2$fv, span = 0.8, degree = 2)
lines(k2$fv, k2$X27, col="#FF00FF", lwd=2.5, type="l", lty=3)

#model3 = loess(k2$X54 ~ k2$fv, span = 0.8, degree = 2)
lines(k2$fv, k2$X54, col="#EE0000", lwd=2.5, type="l", lty=3)

#model4 = loess(k2$X180 ~ k2$fv, span = 0.8, degree =2)
lines(k2$fv, k2$X180, col="#27408B", lwd=2.5, type="l", lty=3)
...
plot(k2$fv, k2$X1.5, xaxs = "i", col = 0, xlab = "0 ~ 75 Hz", ylab = "f_eject in cycle (Hz)", main = "", cex.lab = 1.2, cex.main = 1.5, xlim = c(0,  75), ylim = c(0, 110))

#text(260, 0.85, "射出时间在[0.3ms, 0.8ms]内", font = 2, col = "blue", cex = 1.3)

#model1 = loess(k2$X1.5 ~ k2$fv, span = 1.6 , degree = 2)
lines(k2$fv, k2$X1.5, col="#458B74", lwd=2, type="l")

#model2 = loess(k2$X27 ~ k2$fv, span = 1.6, degree = 2)
lines(k2$fv,  k2$X27, col="#FF00FF", lwd=2, type="l")

#model3 = loess(k2$X54 ~ k2$fv, span = 1.6, degree = 2)
lines(k2$fv, k2$X54, col="#EE0000", lwd=2, type="l")

#model4 = loess(k2$X180 ~ k2$fv, span = 1.6, degree =2)
lines(k2$fv, k2$X180, col="#27408B", lwd=2, type="l")
