...
##################################画图--占空比Q-1.5#######################
plot(q2$fv, q2$X0.2, xaxs = "i", col = 0, xlab = "Voltage frequency (Hz)", ylab = "Frequency in cycle (Hz)", main = "Eject frequency in Q = 1.5nl/min", cex.lab = 1.2, cex.main = 1.5, xlim = c(0, 1050), ylim = c(0, 100))

#model1 = loess(q2$X0.2 ~ q2$fv, span = 0.8 , degree = 2)
lines(q2$fv, q2$X0.2,  col="#458B74", pch=21, lwd=2.5, type="b", lty=2)

#model2 = loess(q2$X0.3 ~ q2$fv, span = 0.8, degree = 2)
lines(q2$fv, q2$X0.3, col="#FF00FF", pch=22, lwd=2.5, type="b", lty=2)

#model3 = loess(q2$X0.4 ~ q2$fv, span = 0.8, degree = 2)
lines(q2$fv, q2$X0.4, col="#EE0000", pch=23, lwd=2.5, type="b", lty=2)

#model4 = loess(q2$X0.5 ~ q2$fv, span = 0.8, degree =2)
lines(q2$fv, q2$X0.5, col="#27408B", pch=24, lwd=2.5, type="b", lty=2)
...
plot(q2$fv, q2$X0.2, xaxs = "i", col = 0, xlab = "0 ~ 250 Hz", ylab = "f_eject in cycle (Hz)", main = "", cex.lab = 1.2, cex.main = 1.5, xlim = c(0, 250), ylim = c(0, 100))

#model1 = loess(q2$X0.2 ~ q2$fv, span = 0.8 , degree = 2)
lines(q2$fv, q2$X0.2,  col="#458B74", lwd=2.5, type="l", lty=3)

#model2 = loess(q2$X0.3 ~ q2$fv, span = 0.8, degree = 2)
lines(q2$fv, q2$X0.3, col="#FF00FF", lwd=2.5, type="l", lty=3)

#model3 = loess(q2$X0.4 ~ q2$fv, span = 0.8, degree = 2)
lines(q2$fv, q2$X0.4, col="#EE0000", lwd=2.5, type="l", lty=3)

#model4 = loess(q2$X0.5 ~ q2$fv, span = 0.8, degree =2)
lines(q2$fv, q2$X0.5, col="#27408B", lwd=2.5, type="l", lty=3)
...
plot(q2$fv, q2$X0.2, xaxs = "i", col = 0, xlab = "0 ~ 75 Hz", ylab = "f_eject in cycle (Hz)", main = "", cex.lab = 1.2, cex.main = 1.5, xlim = c(0,  75), ylim = c(0, 100))
