...
#保存pdf
pdf("acetone_Diameter.pdf")

#########################研究ethanol与nozzle diameter 的关系#################

################################画图-高度曲线###########################
plot(men_rh$voltage, men_rh$X0.81, col=0, xaxs="i", xlim=c(1.4, 2.9), ylim=c(0.1, 1.3), 
...
##############################画图--角度曲线############################
plot(men_ra$voltage, men_ra$X0.81, col=0, xaxs="i", xlim=c(1.4, 2.9), ylim=c(50, 160), 
