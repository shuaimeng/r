...
lines(lowess(n2$fv,1/n2$d_eRn,f=1/4,iter=3),col="blue",pch=2,lwd=1.5,lty=2,type="b",cex=0.8)
lines(lowess(n3$fv,1/n3$d_eRn,f=1/4,iter=3),col="black",pch=15,lwd=1.5,lty=2,type="b",cex=0.8)

legend("bottomright",c("18nl/min","54nl/min","180nl/min"),col=c("red","blue","black"),pch=c(1,2,15),lwd=1.5,lty=2,bty="n",inset=.06)
...
#30g,32g,34g##
lines(lowess(n4$fv,1/n4$d_eRn,f=1/4,iter=3),col="red",pch=1,lwd=1.5,lty=2,type="b",cex=0.8)
lines(lowess(n5$fv,1/n5$d_eRn,f=1/4,iter=3),col="blue",pch=2,lwd=1.5,lty=2,type="b",cex=0.8)
lines(lowess(n6$fv,1/n6$d_eRn,f=1/4,iter=3),col="black",pch=15,lwd=1.5,lty=2,type="b",cex=0.8)

legend("bottomright",c("18nl/min","54nl/min","180nl/min"),col=c("red","blue","black"),pch=c(1,2,15),lwd=1.5,lty=2,bty="n",inset=.08)
...
#30g,32g,34g##
lines(lowess(n7$fv,1/n7$d_eRn,f=1/4,iter=3),col="red",pch=1,lwd=1.5,lty=2,type="b",cex=0.8)
lines(lowess(n8$fv,1/n8$d_eRn,f=1/4,iter=3),col="blue",pch=2,lwd=1.5,lty=2,type="b",cex=0.8)
