...
plot(n1$fv, n1$tf, xlab = expression(f["v"](Hz)),
     ylab=expression(f["e"](Hz)),mgp=c(1.1, 0, 0),tck=0.02,xlim=c(0,300),ylim=c(0,250),col=0)
...
title(main="30G-180nl/min",line=0.5)
legend("topright",c("1.6kv",
                    "1.8kv","2kv","2.2kv"),
       pch=c(1,2,3,4),bty="n",lty=2,col=c("red","blue","black","green3"),inset=.1)


####32G###

plot(n5$fv, n5$tf, xlab = expression(f["v"](Hz)),
     ylab=expression(f["e"](Hz)),mgp=c(1.1, 0, 0),tck=0.02,xlim=c(0,300),ylim=c(0,250),col=0)
...
title(main="32G-180nl/min",line=0.5)
legend("topright",c("1.8kv","2kv","2.2kv"),
       pch=c(1,2,3),bty="n",lty=2,col=c("red","blue","black"),inset=.1)
