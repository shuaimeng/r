...
plot(nj$fv, nj$feeva, xlab = expression(f["v"](Hz)),
     ylab=expression(f["e"](Hz)),mgp=c(1.1, 0, 0),tck=0.02,xlim=c(0,200),ylim=c(0,100),col=0)
#18
...
legend("topright",c("18nl/min",
                    "54nl/min","180nl/min"),
       pch=c(1,2,15),bty="n",lty=2,col=c("red","blue","black"),inset=.18,cex=0.8)
...
###小图###
par(fig=c(0.6,0.98,0.65,0.99),new=T)
plot(na$fv, na$d_ra, xlab = expression(f["v"](Hz)),ylab="",mgp=c(1, 0, 0),tck=0.005,cex.axis=0.8,cex.lab=0.8,xlim=c(0,3000),ylim=c(0,250),col=0)
lines(na$fv,na$feeva,col="red",pch=1,lwd=1.5,lty=2,type="b",cex=0.7)
lines(nc$fv,nc$feeva,col="blue",pch=15,lwd=1.5,lty=2,type="b",cex=0.7)
lines(nb$fv,nb$feeva,col="black",pch=2,lwd=1.5,lty=2,type="b",cex=0.7)
...
legend("topright",c("18nl/min",
                    "54nl/min","180nl/min"),
       pch=c(1,2,15),bty="n",lty=2,col=c("red","blue","black"),cex=0.8,inset=.15)
...
plot(nd$fv, nd$d_ra, xlab = expression(f["v"](Hz)),ylab="",cex.axis=0.8,cex.lab=0.8,mgp=c(1, 0, 0),tck=0.005,xlim=c(0,3500),ylim=c(0,250),col=0)
lines(nd$fv,nd$feeva,col="red",pch=1,lwd=1.5,lty=2,type="b",cex=0.7)
lines(nf$fv,nf$feeva,col="blue",pch=2,lwd=1.5,lty=2,type="b",cex=0.7)
lines(ne$fv,ne$feeva,col="black",pch=15,lwd=1.5,lty=2,type="b",cex=0.7)
...
plot(ng$fv, ng$d_ra, xlab = expression(f["v"](Hz)),ylab="",mgp=c(1, 0, 0),tck=0.005,cex.axis=0.8,cex.lab=0.8,xlim=c(0,3500),ylim=c(0,250),col=0)
lines(ng$fv,ng$feeva,col="red",pch=1,lwd=1.5,lty=2,type="b",cex=0.7)
lines(nh$fv,nh$feeva,col="blue",pch=2,lwd=1.5,lty=2,type="b",cex=0.7)
lines(ni$fv,ni$feeva,col="black",pch=15,lwd=1.5,lty=2,type="b",cex=0.7)
