...
plot(k1$fv,k1$d_r, col=0,xlab = expression(italic(f["v"]) (Hz)),
     ...
     main = "", xlim = c(0,4000),ylim=c(20,100))

     mtext("26G-180nl/min-d",3,line=0.2,font=2,cex=1.2)
...
error.bar(k1$fv,k1$d_r,0,col=yan[1])
...
legend("topright",legend=leg,col=yan,pch=pcc,lwd=1.5,lty=2,inset=.03,bty="n",cex=0.9)
