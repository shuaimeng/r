...
##################################画图--占空比Q-1.5#######################
plot(q2$fv, q2$X0.2, xaxs = "i", col = 0, xlab = "Voltage frequency (Hz)", 
     ylab = "Frequency in cycle (Hz)", main = "Eject frequency in Q = 1.5nl/min", cex.lab = 1.2, cex.main = 1.5, xlim = c(0, 3500), ylim = c(0, 100))
