...
plot(k1$fv,k1$feeva, xaxs="i", col=0, xlab = expression(italic(f["v"]) (Hz)), 
     ...
     cex.lab=1,xlim=c(0,3500),ylim=c(0,4000))
...
lines(k1$fv, k1$feeva*k1$fv,col="red", lwd=2, pch=0,type="b", lty=2)
lines(k2$fv, k2$feeva*k2$fv,col="blue", lwd=2, pch=1,type="b", lty=2)
lines(k3$fv, k3$feeva*k3$fv,col="green3", lwd=2, pch=2,type="b", lty=2)
lines(k4$fv, k4$feeva*k4$fv,col="black", lwd=2, pch=5,type="b", lty=2)

error.bar(k1$fv,k1$feeva*k1$fv,k1$stdfe*k1$fv/2,col=yan[1])
error.bar(k2$fv,k2$feeva*k2$fv,k2$stdfe*k2$fv/2,col=yan[2])
error.bar(k3$fv,k3$feeva*k3$fv,k3$stdfe*k3$fv/2,col=yan[3])
error.bar(k4$fv,k4$feeva*k4$fv,k4$stdfe*k4$fv/2,col=yan[4])
