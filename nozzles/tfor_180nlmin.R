...
#lines(lowess(nb$fv,nb$tf,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
lines(lowess(nc$fv,nc$tf,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")


#32g
#lines(lowess(nd$fv,nd$tf,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
#lines(lowess(ne$fv,ne$tf,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
lines(lowess(nf$fv,nf$tf,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")

#34g
#lines(lowess(ng$fv,ng$tf,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
#lines(lowess(nh$fv,nh$tf,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
lines(lowess(ni$fv,ni$tf,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")


title(main="tfor in 180nlmin",line=0.5)

legend("topright",c("30g","32g","34g"),
