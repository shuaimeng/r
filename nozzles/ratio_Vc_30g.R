...
#30g
lines(lowess(na16$fv,1/na16$d_eRn,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
#arrows(na$fv,(na$d_e+0.5*na$sd),na$fv,(na$d_e-0.5*na$sd), length=0.05,angle=90,code=3)

lines(lowess(na18$fv,1/na18$d_eRn,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
#arrows(nb$fv,(nb$d_e+0.5*nb$sd),nb$fv,(nb$d_e-0.5*nb$sd), length=0.05,angle=90,code=3)

lines(lowess(nc$fv,1/nc$d_eRn,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
#arrows(nc$fv,(nc$d_e+0.5*nc$sd),nc$fv,(nc$d_e-0.5*nc$sd), length=0.05,angle=90,code=3)

lines(na22$fv,1/na22$d_eRn,col="green3",pch=16,lwd=2,lty=2,type="b")
...
title(main="Ratio in 30G&Vc",line=0.5)

legend("bottomright",c("1.6kv","1.8kv","2kv","2.2kv"),
