...
#30g
lines(na16$fv,((500/na16$fv - na16$tf)/na16$tp),col="red",pch=1,lwd=2,lty=2,type="b")
lines(na18$fv,((500/na18$fv - na18$tf)/na18$tp),col="blue",pch=2,lwd=2,lty=2,type="b")
lines(nc$fv,((500/nc$fv - nc$tf)/nc$tp),col="black",pch=15,lwd=2,lty=2,type="b")
lines(na22$fv,((500/na22$fv - na22$tf)/na22$tp),col="green3",pch=16,lwd=2,lty=2,type="b")
...
title(main="Fe in kv&30G",line=0.5)
