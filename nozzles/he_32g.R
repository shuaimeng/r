...
plot(na$fv, na$he_ra, xlab = expression(f["v"](Hz)),
     ylab=expression(h["m"](um)),mgp=c(1, 0, 0),tck=0.02,ylim=c(0,200),col=0)

lines(lowess(nd$fv,nd$he_r,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
