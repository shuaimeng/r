...
#30g
lines(lowess(nc18$fv,1/nc18$d_eRn,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
#arrows(na$fv,(na$d_e+0.5*na$sd),na$fv,(na$d_e-0.5*na$sd), length=0.05,angle=90,code=3)

lines(lowess(ni$fv,1/ni$d_eRn,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
...
title(main="Ratio in 34G&Vc",line=0.5)
