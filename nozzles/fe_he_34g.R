...
plot(na$fv, na$d_ra, xlab = expression(h["m"](um)),
     ylab=expression(f["e"](Hz)),mgp=c(1, 0, 0),tck=0.02,xlim=c(50,120),ylim=c(0,150),col=0)
...
#34g
points(ng$he_r,((500/ng$fv - ng$tf)/ng$tp),col="red",pch=1,lwd=2,lty=2)
points(nh$he_r,((500/nh$fv - nh$tf)/nh$tp),col="blue",pch=2,lwd=2,lty=2)
points(ni$he_r,((500/ni$fv - ni$tf)/ni$tp),col="black",pch=15,lwd=2,lty=2)
points(nc360$he_r,((500/nc360$fv - nc360$tf)/nc360$tp),col="green3",pch=16,lwd=2,lty=2)
