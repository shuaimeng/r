...
#lines(lowess(ne$fv,(110/ne$d_r),f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
...
#lines(lowess(nh$fv,(60/nh$d_r),f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
