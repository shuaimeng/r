...
#lines(lowess(nk$fv,nk$d_r,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
...
#lines(lowess(nc$fv,nc$d_r,f=1/4,iter=3),col="black",pch=3,lwd=2,lty=2,type="b")
#lines(lowess(na360$fv,na360$d_r,f=1/4,iter=3),col="green3",pch=4,lwd=2,lty=2,type="b")
...
#lines(lowess(nf$fv,nf$d_r,f=1/4,iter=3),col="black",pch=3,lwd=2,lty=2,type="b")
...
title(main="Droplets in 18nlmin",line=0.5)
