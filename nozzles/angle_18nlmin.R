...
###画图###
###
plot(na$fv, na$ana, xlab = expression(f["v"](Hz)),
...
#lines(lowess(nk$fv,nk$an,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
#lines(lowess(nl$fv,nl$an,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
...
#lines(lowess(nb$fv,nb$an,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
#lines(lowess(nc$fv,nc$an,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
...
#lines(lowess(ne$fv,ne$an,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
#lines(lowess(nf$fv,nf$an,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")


#34g
lines(lowess(ng$fv,(atan(ng$an)*180/pi),f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")
#lines(lowess(nh$fv,nh$an,f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")
#lines(lowess(ni$fv,ni$an,f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")
#lines(lowess(nc360$fv,nc360$an,f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")


title(main="Angles in 18nlmin",line=0.5)

legend("bottom",c("25g","30g","32g","34g"),
