...
#lines(lowess(nl$fv,nl$he_r,f=1/4,iter=3),col="black",pch=3,lwd=2,lty=2,type="b")
#lines(lowess(na360$fv,na360$he_r,f=1/4,iter=3),col="green3",pch=4,lwd=2,lty=2,type="b")



#30g
#lines(lowess(na$fv,na$he_r,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
lines(lowess(nb$fv,nb$he_r,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
#lines(lowess(nc$fv,nc$he_r,f=1/4,iter=3),col="black",pch=3,lwd=2,lty=2,type="b")
#lines(lowess(na360$fv,na360$he_r,f=1/4,iter=3),col="green3",pch=4,lwd=2,lty=2,type="b")

#32g
#lines(lowess(nd$fv,nd$he_r,f=1/4,iter=3),col="black",pch=2,lwd=2,lty=2,type="b")
lines(lowess(ne$fv,ne$he_r,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
#lines(lowess(nf$fv,nf$he_r,f=1/4,iter=3),col="black",pch=3,lwd=2,lty=2,type="b")


#34g
#lines(lowess(ng$fv,ng$he_r,f=1/4,iter=3),col="green3",pch=15,lwd=2,lty=2,type="b")
lines(lowess(nh$fv,nh$he_r,f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")
#lines(lowess(ni$fv,ni$he_r,f=1/4,iter=3),col="black",pch=3,lwd=2,lty=2,type="b")
#lines(lowess(nc360$fv,nc360$he_r,f=1/4,iter=3),col="green3",pch=4,lwd=2,lty=2,type="b")


title(main="54nlmin in Nozzles",line=0.5)
