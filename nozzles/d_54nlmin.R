...
#lines(lowess(nl$fv,nl$d_r,f=1/4,iter=3),col="black",pch=3,lwd=2,lty=2,type="b")
...
#lines(lowess(ni$fv,ni$d_r,f=1/4,iter=3),col="black",pch=3,lwd=2,lty=2,type="b")
#lines(lowess(nc360$fv,nc360$d_r,f=1/4,iter=3),col="green3",pch=4,lwd=2,lty=2,type="b")

title(main="Droplet in 54nlmin",line=0.5)
