...
#32g
lines(nd$fv,((500/nd$fv - nd$tf)/nd$tp),col="red",pch=1,lwd=2,lty=2,type="b")
lines(ne$fv,((500/ne$fv - ne$tf)/ne$tp),col="blue",pch=2,lwd=2,lty=2,type="b")
