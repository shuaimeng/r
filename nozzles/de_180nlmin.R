...
#lines(lowess(nb$fv,nb$d_e,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
#arrows(nb$fv,(nb$d_e+0.5*nb$sd),nb$fv,(nb$d_e-0.5*nb$sd), length=0.05,angle=90,code=3)

lines(lowess(nc$fv,nc$d_e,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
...
#32g
#lines(lowess(nd$fv,nd$d_e,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
...
lines(lowess(nf$fv,nf$d_e,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
#arrows(nf$fv,(nf$d_e+0.5*nf$sd),nf$fv,(nf$d_e-0.5*nf$sd), length=0.05,angle=90,code=3)



#34g
#lines(lowess(ng$fv,ng$d_e,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
#lines(lowess(nh$fv,nh$d_e,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
...
abline(lm(nc$d_e~nc$fv),col="red",lty=4)

abline(lm(nf$d_e~nf$fv),col="blue",lty=4)

abline(lm(ni$d_e~ni$fv),col="black",lty=4)
