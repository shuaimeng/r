...
#30g
lines(lowess(na16$fv,na16$he_r,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
lines(lowess(na18$fv,na18$he_r,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
lines(lowess(nc$fv,nc$he_r,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
lines(lowess(na22$fv,na22$he_r,f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")
...
title(main="Height in kv&30G",line=0.5)
