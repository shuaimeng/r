...
#points(lowess(a,nb$d_eRn,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2)
...
#points(lowess(b,ne$d_eRn,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2)
points(lowess(b,nf$d_eRn,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2)
...
#points(lowess(c,nh$d_eRn,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2)
points(lowess(c,ni$d_eRn,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2)

title(main="d/D ~ Q_e in 180nlmin",line=0.5)
