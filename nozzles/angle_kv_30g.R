...
#30g
lines(lowess(na16$fv,(atan(na16$an)*180/pi),f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
lines(lowess(na18$fv,(atan(na18$an)*180/pi),f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
lines(lowess(nc$fv,(atan(nc$an)*180/pi),f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
lines(lowess(na22$fv,(atan(na22$an)*180/pi),f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")

#32g
#lines(lowess(nd$fv,(atan(nd$an)*180/pi),f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
#lines(lowess(ne$fv,(atan(ne$an)*180/pi),f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
#lines(lowess(nf$fv,(atan(nf$an)*180/pi),f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")


#34g
#lines(lowess(ng$fv,(atan(ng$an)*180/pi),f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
#lines(lowess(nh$fv,(atan(nh$an)*180/pi),f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
...
title(main="Angles in kv&30G",line=0.5)

legend("bottom",c("1.6kv","1.8kv","2kv","2.2kv"),
