...
#30g
#lines(lowess(na$fv,((500/na$fv - na$tf)/na$tp),f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
#lines(lowess(nb$fv,((500/nb$fv - nb$tf)/nb$tp),f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
#lines(lowess(nc$fv,((500/nc$fv - nc$tf)/nc$tp),f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
#lines(lowess(na360$fv,((500/na360$fv - na360$tf)/na360$tp),f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")
