...
#lines(lowess(ne$fv,ne$he_r,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
...
#lines(lowess(nh$fv,nh$he_r,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
...
title(main="18nlmin in Nozzles",line=0.5)
