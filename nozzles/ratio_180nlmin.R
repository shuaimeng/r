...
plot(na$fv, na$d_ra, xlab = expression(f["v"](Hz)),
     ylab=expression(ratio),mgp=c(1, 0, 0),tck=0.02,xlim=c(0,3500),ylim=c(0,20),col=0)


#25g
#points(nk$fv,(260/nk$d_r),col="red",pch=1,lwd=2,lty=2)
#points(nl$fv,(260/nl$d_r),col="red",pch=1,lwd=2,lty=2)
points(nd1$fv,(260/nd1$d_r),col="red",pch=1,lwd=2,lty=2)
#points(nd2$fv,(260/nd2$d_r),col="blue",pch=16,lwd=2,lty=2)



#30g
#lines(lowess(na$fv,(160/na$d_r),f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
#lines(lowess(nb$fv,(160/nb$d_r),f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
lines(lowess(nc$fv,(160/nc$d_r),f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
#lines(lowess(na360$fv,(160/na360$d_r),f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")

#32g
#lines(lowess(nd$fv,(110/nd$d_r),f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
#lines(lowess(ne$fv,(110/ne$d_r),f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
lines(lowess(nf$fv,(110/nf$d_r),f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")


#34g
#lines(lowess(ng$fv,(60/ng$d_r),f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")
#lines(lowess(nh$fv,(60/nh$d_r),f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")
lines(lowess(ni$fv,(60/ni$d_r),f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")
#lines(lowess(nc360$fv,(60/nc360$d_r),f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")

title(main="Ratio in 180nlmin",line=0.5)

legend("topright",c("25g","30g","32g","34g"),
