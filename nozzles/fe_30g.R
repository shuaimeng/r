...
#30g
lines(na$fv,((500/na$fv - na$tf)/na$tp),col="red",pch=1,lwd=2,lty=2,type="b")
...
lines(na360$fv,((500/na360$fv - na360$tf)/na360$tp),col="green3",pch=16,lwd=2,lty=2,type="b")
