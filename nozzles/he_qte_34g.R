...
points(lowess(a,ng$d_Rn,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2)
points(lowess(b,nh$d_Rn,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2)
points(lowess(c,ni$d_Rn,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2)
points(lowess(d,nc360$d_Rn,f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2)

title(main="d/Rn ~ Q_e in 34G",line=0.5)
