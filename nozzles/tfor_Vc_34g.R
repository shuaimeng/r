...
#30g
#points(na16$fv,na16$tf,col="red",pch=1,lwd=2,lty=2)
#points(na18$fv,na18$tf,col="blue",pch=2,lwd=2,lty=2)
#points(nc$fv,nc$tf,col="black",pch=15,lwd=2,lty=2)
#points(na22$fv,na22$tf,col="green3",pch=15,lwd=2,lty=2)


#32g
#lines(lowess(nb18$fv,nb18$tf,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
#lines(lowess(nf$fv,nf$tf,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
#lines(lowess(nb22$fv,nb22$tf,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")

#34g
lines(lowess(nc18$fv,nc18$tf,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
lines(lowess(ni$fv,ni$tf,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
#lines(lowess(ni$fv,ni$tf,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")


title(main="tfor in Vc&34G",line=0.5)
