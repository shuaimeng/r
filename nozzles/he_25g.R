...
plot(na$fv, na$he_ra, xlab = expression(f["v"](Hz)),
     ylab=expression(h["m"](um)),mgp=c(1, 0, 0),tck=0.02,xlim=c(0,1000),ylim=c(200,500),col=0)

lines(lowess(nj$fv,nj$he_r,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
lines(lowess(nk$fv,nk$he_r,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
lines(lowess(nl$fv,nl$he_r,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
#lines(lowess(na360$fv,na360$he_r,f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")

title(main="he in 25G",line=0.5)
