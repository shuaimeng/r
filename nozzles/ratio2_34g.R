...
###画图###
###
plot(na$fv, na$d_ea, xlab = expression(f["v"](Hz)),
     ylab="ratio",mgp=c(1, 0, 0),tck=0.02,xlim=c(0,3500),ylim=c(0,15),col=0)
...
#34g
lines(lowess(ng$fv,1/ng$d_eRn,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
lines(lowess(nh$fv,1/nh$d_eRn,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
...
legend("topright",c("18nlmin","54nlmin","180nlmin"),
