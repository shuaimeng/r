...
#25g
#lines(lowess(nj$fv,nj$d_r,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
#lines(lowess(nk$fv,nk$d_r,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
lines(lowess(nl$fv,nl$d_r,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
#lines(lowess(na360$fv,na360$d_r,f=1/4,iter=3),col="green3",pch=4,lwd=2,lty=2,type="b")



#30g
#lines(lowess(na$fv,na$d_r,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
#lines(lowess(nb$fv,nb$d_r,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
lines(lowess(nc$fv,nc$d_r,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
#lines(lowess(na360$fv,na360$d_r,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")

#32g
#lines(lowess(nd$fv,nd$d_r,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
#lines(lowess(ne$fv,ne$d_r,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
lines(lowess(nf$fv,nf$d_r,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")


#34g
#lines(lowess(ng$fv,ng$d_r,f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")
#lines(lowess(nh$fv,nh$d_r,f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")
lines(lowess(ni$fv,ni$d_r,f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")
#lines(lowess(nc360$fv,nc360$d_r,f=1/4,iter=3),col="green3",pch=4,lwd=2,lty=2,type="b")

title(main="Droplet in 180nlmin",line=0.5)
