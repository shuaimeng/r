...
lines(lowess(nb$fv,1/nb$d_eRn,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
...
lines(lowess(nh$fv,1/nh$d_eRn,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
