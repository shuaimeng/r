...
lines(lowess(ng$fv,ng$he_r,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
lines(lowess(nh$fv,nh$he_r,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
lines(lowess(ni$fv,ni$he_r,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
lines(lowess(nc360$fv,nc360$he_r,f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")

title(main="he in 34G",line=0.5)
