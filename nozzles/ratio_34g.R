...
plot(na$fv, na$d_ra, xlab = expression(f["v"](Hz)),
     ylab=expression(ratio),mgp=c(1, 0, 0),tck=0.02,xlim=c(0,3500),ylim=c(0,10),col=0)
...
#32g
#lines(lowess(nd$fv,(110/nd$d_r),f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
...
#34g
lines(lowess(ng$fv,(60/ng$d_r),f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
...
title(main="Ratio in 34G",line=0.5)
