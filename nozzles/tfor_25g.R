...
#34g
lines(lowess(nj$fv,nj$tf,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
lines(lowess(nk$fv,nk$tf,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
lines(lowess(nl$fv,nl$tf,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")


title(main="tfor in 25G",line=0.5)

legend("topright",c("1.8nlmin","54nlmin","180nlmin"),
