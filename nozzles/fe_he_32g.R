...
plot(na$fv, na$d_ra, xlab = expression(h["m"](um)),
     ylab=expression(f["e"](Hz)),mgp=c(1, 0, 0),tck=0.02,xlim=c(100,150),ylim=c(0,100),col=0)
...
#32g
points(nd$he_r,((500/nd$fv - nd$tf)/nd$tp),col="red",pch=1,lwd=2,lty=2)
points(ne$he_r,((500/ne$fv - ne$tf)/ne$tp),col="blue",pch=2,lwd=2,lty=2)
points(nf$he_r,((500/nf$fv - nf$tf)/nf$tp),col="black",pch=15,lwd=2,lty=2)
...
title(main="Fe&he in 32G",line=0.5)
