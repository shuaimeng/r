...
lines(lowess(nc$fv,nc$he_ra,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
lines(lowess(nf$fv,nf$he_ra,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
...
title(main="he/ra in 180nlmin",line=0.5)
