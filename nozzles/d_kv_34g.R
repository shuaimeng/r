...
#34g
lines(lowess(nc18$fv,nc18$d_r,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
lines(lowess(ni$fv,ni$d_r,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
...
title(main="Droplet in kv&34G",line=0.5)
