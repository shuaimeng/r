...
plot(na$fv, na$he_raa, xlab = expression(f["v"](Hz)),
     ...
     tck=0.02,xlim=c(0,500),ylim=c(0,60),col=0)
...
#30g
#lines(lowess(na$fv,(atan(na$he_ra)*180/pi),f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
#lines(lowess(nb$fv,nb$he_ra,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
#lines(lowess(nc$fv,nc$he_ra,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
#lines(lowess(na360$fv,na360$he_ra,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")

#32g
#lines(lowess(nd$fv,(atan(nd$he_ra)*180/pi),f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
#lines(lowess(ne$fv,ne$he_ra,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
#lines(lowess(nf$fv,nf$he_ra,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")


#34g
#lines(lowess(ng$fv,(atan(ng$he_ra)*180/pi),f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")
#lines(lowess(nh$fv,nh$he_ra,f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")
#lines(lowess(ni$fv,ni$he_ra,f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")
#lines(lowess(nc360$fv,nc360$he_ra,f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")


title(main="Angles in 25G",line=0.5)

legend("top",c("18nlmin","54nlmin","180nlmin"),
