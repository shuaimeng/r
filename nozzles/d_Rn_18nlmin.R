...
#points(lowess(b,nb$d_eRn,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2)
#points(lowess(c,nc$d_eRn,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2)
...
title(main="d/D ~ Q_e in 18nlmin",line=0.5)
