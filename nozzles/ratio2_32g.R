...
#30g
#lines(lowess(na$fv,na$d_r,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
...
#32g
lines(lowess(nd$fv,1/nd$d_eRn,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
...
lines(lowess(nf$fv,1/nf$d_eRn,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
...
title(main="Ratio in 32G",line=0.5)
