...
a<-log(500*18/(nj$fv*60*5.1^3))
b<-log(500*54/(nk$fv*60*5.1^3))
c<-log(500*180/(nl$fv*60*5.1^3))
#d<-log(500*360/(na360$fv*60*5.1^3))

points(lowess(a,nj$d_Rn,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2)
points(lowess(b,nk$d_Rn,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2)
points(lowess(c,nl$d_Rn,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2)
#points(lowess(d,na360$d_Rn,f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2)

title(main="d/Rn ~ Q_e in 25G",line=0.5)
