...
lines(lowess(nb18$fv,nb18$d_e,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
...
lines(lowess(nb22$fv,nb22$d_e,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
...
title(main="Droplet in 32G&Vc",line=0.5)
