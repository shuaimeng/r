...
plot(na$fv, na$d_ra, xlab = expression(f["v"](Hz)),
     ylab=expression(ratio),mgp=c(1, 0, 0),tck=0.02,xlim=c(0,1000),ylim=c(0,20),col=0)
...
title(main="Ratio in kv&25G",line=0.5)

legend("topright",c("2kv-54nlmin","2kv-180nlmin","2.2kv-54nlmin","2.2kv-180nlmin"),
