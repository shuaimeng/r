...
plot(na$fv, na$d_ra, xlab = expression(f["v"](Hz)),
     ...
     tck=0.02,xlim=c(0,3500),ylim=c(0,1),col=0)
...
#34g
lines(lowess(ng$fv,ng$tf,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
lines(lowess(nh$fv,nh$tf,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
lines(lowess(ni$fv,ni$tf,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")


title(main="tfor in 34G",line=0.5)
