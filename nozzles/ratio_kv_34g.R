...
#32g
#lines(lowess(nb18$fv,(110/nb18$d_r),f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
#lines(lowess(nf$fv,(110/nf$d_r),f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
#lines(lowess(nb22$fv,(110/nb22$d_r),f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")


#34g
lines(lowess(nc18$fv,(60/nc18$d_r),f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
lines(lowess(ni$fv,(60/ni$d_r),f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
...
title(main="Ratio in kv&34G",line=0.5)
