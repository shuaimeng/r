...
#32g
lines(nb18$fv,((500/nb18$fv - nb18$tf)/nb18$tp),col="red",pch=1,lwd=2,lty=2,type="b")
lines(nf$fv,((500/nf$fv - nf$tf)/nf$tp),col="blue",pch=2,lwd=2,lty=2,type="b")

lines(nb22$fv,((500/nb22$fv - nb22$tf)/nb22$tp),col="black",pch=15,lwd=2,lty=2,type="b")
...
title(main="Fe in kv&32G",line=0.5)
