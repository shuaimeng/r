...
lines(lowess(nb$fv,1/nb$d_eRn,f=1/4,iter=3),col="red",pch=2,lwd=2,lty=2,type="b")
#arrows(nb$fv,(nb$d_e+0.5*nb$sd),nb$fv,(nb$d_e-0.5*nb$sd), length=0.05,angle=90,code=3)

lines(lowess(nc$fv,1/nc$d_eRn,f=1/4,iter=3),col="red",pch=15,lwd=2,lty=2,type="b")
...
#32g
lines(lowess(nd$fv,1/nd$d_eRn,f=1/4,iter=3),col="blue",pch=1,lwd=2,lty=2,type="b")
#arrows(nd$fv,(nd$d_e+0.5*nd$sd),nd$fv,(nd$d_e-0.5*nd$sd), length=0.05,angle=90,code=3)


lines(lowess(ne$fv,1/ne$d_eRn,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
#arrows(ne$fv,(ne$d_e+0.5*ne$sd),ne$fv,(ne$d_e-0.5*ne$sd), length=0.05,angle=90,code=3)


lines(lowess(nf$fv,1/nf$d_eRn,f=1/4,iter=3),col="blue",pch=15,lwd=2,lty=2,type="b")
#arrows(nf$fv,(nf$d_e+0.5*nf$sd),nf$fv,(nf$d_e-0.5*nf$sd), length=0.05,angle=90,code=3)



#34g
lines(lowess(ng$fv,1/ng$d_eRn,f=1/4,iter=3),col="black",pch=1,lwd=2,lty=2,type="b")
lines(lowess(nh$fv,1/nh$d_eRn,f=1/4,iter=3),col="black",pch=2,lwd=2,lty=2,type="b")
lines(lowess(ni$fv,1/ni$d_eRn,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
#lines(lowess(nc360$fv,nc360$d_e,f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")

title(main="Ratio in all",line=0.5)

legend("bottomright",c("30g-18","30g-54","30g-180","32g-18","32g-54",
