...
plot(na$fv, na$d_ra, xlab = expression(f["v"](Hz)),
     ylab=expression(f["e"](Hz)),mgp=c(1, 0, 0),tck=0.02,xlim=c(0,500),ylim=c(0,100),col=0)


#25g
lines(nj$fv,((500/nj$fv - nj$tf)/nj$tp),col="red",pch=1,lwd=2,lty=2,type="b")
lines(nk$fv,((500/nk$fv - nk$tf)/nk$tp),col="blue",pch=2,lwd=2,lty=2,type="b")
lines(nl$fv,((500/nl$fv - nl$tf)/nl$tp),col="black",pch=15,lwd=2,lty=2,type="b")
