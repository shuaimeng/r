...
plot(na$fv, na$d_ra, xlab = expression(f["v"](Hz)),
     ylab=expression(d["d"](um)),mgp=c(1, 0, 0),tck=0.02,xlim=c(0,3500),ylim=c(0,150),col=0)
...
#30g
lines(lowess(na16$fv,na16$d_e,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
#arrows(na$fv,(na$d_e+0.5*na$sd),na$fv,(na$d_e-0.5*na$sd), length=0.05,angle=90,code=3)

lines(lowess(na18$fv,na18$d_e,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
...
lines(na22$fv,na22$d_e,col="green3",pch=16,lwd=2,lty=2,type="b")
...
title(main="Droplet in 30G&Vc",line=0.5)
