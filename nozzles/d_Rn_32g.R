...
points(lowess(a,nd$d_eRn,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2)
points(lowess(b,ne$d_eRn,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2)
points(lowess(c,nf$d_eRn,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2)
#points(lowess(d,nc360$d_eRn,f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2)

title(main="d/D ~ Q_e in 32G",line=0.5)
