...
plot(na$fv, na$d_ra, xlab = expression(h["m"](um)),
     ylab=expression(f["e"](Hz)),mgp=c(1, 0, 0),tck=0.02,xlim=c(0.4,1),ylim=c(0,150),col=0)
...
#30g
points(na$he_ra,((500/na$fv - na$tf)/na$tp),col="red",pch=1,lwd=2,lty=2)
...
#32g
points(nd$he_ra,((500/nd$fv - nd$tf)/nd$tp),col="blue",pch=2,lwd=2,lty=2)
...
#34g
points(ng$he_ra,((500/ng$fv - ng$tf)/ng$tp),col="black",pch=15,lwd=2,lty=2)
#points(nh$he_r,nh$tf,col="blue",pch=2,lwd=2,lty=2)
#points(ni$he_r,ni$tf,col="black",pch=15,lwd=2,lty=2)
#points(nc360$he_r,nc360$tf,col="green3",pch=16,lwd=2,lty=2)

title(main="Fe&he in 18nlmin",line=0.5)
