...
#30g
lines(lowess(na16$fv,(160/na16$d_r),f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
lines(lowess(na18$fv,(160/na18$d_r),f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
lines(lowess(nc$fv,(160/nc$d_r),f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
lines(lowess(na22$fv,(160/na22$d_r),f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")
...
title(main="Ratio in kv&30G",line=0.5)

legend("topright",c("1.6kv","1.8kv","2kv","2.2kv"),
