...
plot(na$fv, na$d_ra, xlab = expression(f["v"](Hz)),
     ylab=expression(h["m"](um)),mgp=c(1, 0, 0),tck=0.02,xlim=c(0,1000),ylim=c(200,400),col=0)


#25g
points(nk$fv,nk$he_r,col="red",pch=1,lwd=2,lty=2)
points(nl$fv,nl$he_r,col="blue",pch=2,lwd=2,lty=2)
points(nd1$fv,nd1$he_r,col="red",pch=15,lwd=2,lty=2)
points(nd2$fv,nd2$he_r,col="blue",pch=16,lwd=2,lty=2)
...
title(main="Height in kv&25G",line=0.5)

legend("bottomright",c("2kv-54nlmin","2kv-180nlmin",
                    "2.2kv-54nlmin","2kv-180nlmin"),
