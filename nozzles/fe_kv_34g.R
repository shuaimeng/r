...
#lines(lowess(nk$fv,((500/nk$fv - nk$tf)/nk$tp),f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2)
#lines(lowess(nl$fv,((500/nl$fv - nl$tf)/nl$tp),f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2)
#lines(nd2$fv,nd2$d_r,col="blue",pch=16,lwd=2,lty=2)



#30g
#lines(lowess(na16$fv,((500/na16$fv - na16$tf)/na16$tp),f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
#lines(lowess(na18$fv,((500/na18$fv - na18$tf)/na18$tp),f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
#lines(lowess(nc$fv,((500/nc$fv - nc$tf)/nc$tp),f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
#lines(lowess(na22$fv,((500/na22$fv - na22$tf)/na22$tp),f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")

#32g
#lines(lowess(nb18$fv,((500/nb18$fv - nb18$tf)/nb18$tp),f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
#lines(lowess(nf$fv,((500/nf$fv - nf$tf)/nf$tp),f=1/4,iter=3),col="blue",pch=15,lwd=2,lty=2,type="b")

#lines(lowess(nb22$fv,((500/nb22$fv - nb22$tf)/nb22$tp),f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")


#34g
lines(ni$fv,((500/ni$fv - ni$tf)/ni$tp),col="red",pch=1,lwd=2,lty=2,type="b")
lines(nc18$fv,((500/nc18$fv - nc18$tf)/nc18$tp),col="blue",pch=2,lwd=2,lty=2,type="b")
...
title(main="Fe in kv&34G",line=0.5)

legend("topright",c("1.8kv","2kv"),
