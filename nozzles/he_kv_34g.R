...
plot(na$fv, na$d_ra, xlab = expression(f["v"](Hz)),
     ylab=expression(h["m"](um)),mgp=c(1, 0, 0),tck=0.02,xlim=c(0,3500),ylim=c(0,400),col=0)


#25g
#points(nk$fv,nk$d_r,col="red",pch=1,lwd=2,lty=2)
#points(nl$fv,nl$d_r,col="blue",pch=2,lwd=2,lty=2)
#points(nd1$fv,nd1$d_r,col="red",pch=15,lwd=2,lty=2)
#points(nd2$fv,nd2$d_r,col="blue",pch=16,lwd=2,lty=2)



#30g
#lines(lowess(na16$fv,na16$d_r,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
#lines(lowess(na18$fv,na18$d_r,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
...
#32g
#lines(lowess(nb18$fv,nb18$d_r,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
#lines(lowess(nf$fv,nf$d_r,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
#lines(lowess(nb22$fv,nb22$d_r,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")


#34g
lines(lowess(nc18$fv,nc18$he_r,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
lines(lowess(ni$fv,ni$he_r,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
...
title(main="Height in kv&34G",line=0.5)

legend("topright",c("1.8kv",
                    "2kv"),
