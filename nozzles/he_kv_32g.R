...
#32g
lines(lowess(nb18$fv,nb18$he_r,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
lines(lowess(nf$fv,nf$he_r,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
lines(lowess(nb22$fv,nb22$he_r,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
...
title(main="Height in kv&32G",line=0.5)
