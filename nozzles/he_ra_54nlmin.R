...
lines(lowess(nb$fv,nb$he_ra,f=1/4,iter=3),col="red",pch=1,lwd=2,lty=2,type="b")
lines(lowess(ne$fv,ne$he_ra,f=1/4,iter=3),col="blue",pch=2,lwd=2,lty=2,type="b")
lines(lowess(nh$fv,nh$he_ra,f=1/4,iter=3),col="black",pch=15,lwd=2,lty=2,type="b")
#lines(lowess(na360$fv,na360$he_ra,f=1/4,iter=3),col="green3",pch=16,lwd=2,lty=2,type="b")

title(main="he/ra in 54nlmin",line=0.5)
